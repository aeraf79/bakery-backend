...
public class EmailService {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // ORDER CONFIRMATION — NOT @Async
    // Extracts all lazy Hibernate data synchronously while the caller's
    // @Transactional session is still open, then hands off plain values to
    // the @Async sender below.
    // ─────────────────────────────────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // PLAIN VALUE OBJECT — carries item data safely across thread boundary
    // ─────────────────────────────────────────────────────────────────────────
    ...
    private String buildOrderHtml(
        ...
        String paymentNote  = isCod
            ? "<div style='background:#fffbeb;border-left:4px solid #f59e0b;padding:14px 16px;border-radius:6px;margin:20px 0;color:#92400e;font-size:14px;'>"
              + "<strong>💡 Reminder:</strong> Please keep exact change of <strong>" + finalAmount + "</strong> ready for our delivery partner.</div>"
            : "<div style='background:#f0fdf4;border-left:4px solid #22c55e;padding:14px 16px;border-radius:6px;margin:20px 0;color:#166534;font-size:14px;'>"
        ...
        return "<!DOCTYPE html><html><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1'></head>"
            ...
            + "<div style='max-width:620px;margin:30px auto;background:#fff;border-radius:14px;overflow:hidden;box-shadow:0 4px 24px rgba(139,69,19,0.13);'>"
            ...
            + "<p style='color:#f8d7a0;margin:10px 0 0;font-size:14px;'>Thank you for choosing our artisan bakery</p></div>"
            + "<div style='padding:28px 30px 0;'><h2 style='color:#3d1f08;margin:0 0 6px;font-size:20px;'>Hi " + esc(customerName) + "! 👋</h2>"
            ...
            + "<p style='margin:4px 0 0;font-weight:700;color:#8B4513;font-size:15px;'>#" + esc(orderNumber) + "</p></td>"
            + "<td style='padding:14px 18px;border-right:1px solid #fde8d0;'>"
            + "<p style='margin:0;font-size:11px;color:#aaa;text-transform:uppercase;letter-spacing:1px;'>Date</p>"
            + "<p style='margin:4px 0 0;font-weight:600;color:#3d1f08;font-size:13px;'>" + orderDate + "</p></td>"
            + "<td style='padding:14px 18px;'>"
            + "<p style='margin:0;font-size:11px;color:#aaa;text-transform:uppercase;letter-spacing:1px;'>Payment</p>"
            + "<p style='margin:4px 0 0;font-weight:600;font-size:13px;color:" + paymentColor + ";'>" + paymentBadge + "</p></td>"
            + "</tr></table></div>"
            ...
            + "<div style='padding:14px 30px;'><table style='width:100%;border-collapse:collapse;'>"
    ...
    private String buildWelcomeHtml(String fullName) {
        return "<!DOCTYPE html><html><head><meta charset='UTF-8'></head>"
            ...
            + "<h1 style='color:#fff;margin:0;font-size:26px;'>Welcome to the Bakery! 🥐</h1></div>"
            ...
            + "<p>Happy Shopping! 🛍️</p><p><strong>— The Maison Dorée Team</strong></p></div>"
            + "<div style='background:#3d1f08;text-align:center;padding:16px;font-size:12px;color:#c8a06c;'>"
            + "© 2025 Maison Dorée Bakery. All rights reserved.</div></div></body></html>";
    }
